// Project Detailed Data Store (Vietnamese)
const projectData = {
  1: {
    badge: "Bài tập 1",
    ...
    process: `
      <ol style="margin-left: 20px; display: flex; flex-direction: column; gap: 12px; font-size: 13px;">
        <li><strong>Mở File Explorer:</strong> Nhấn tổ hợp phím Windows + E hoặc nhấp vào biểu tượng thư mục màu vàng trên thanh tác vụ.<br><img src="assets/Bài 1/1.1.png" style="max-width: 100%; border-radius: 4px; margin-top: 8px;"></li>
        <li><strong>Truy cập ổ đĩa/thư mục:</strong> Ở cột bên trái, nhấp vào This PC, sau đó nhấp đúp vào một ổ đĩa không phải ổ hệ thống (ví dụ: ổ D: hoặc E:). Nếu chỉ có ổ C:, hãy vào thư mục Documents.<br><img src="assets/Bài 1/1.2.png" style="max-width: 100%; border-radius: 4px; margin-top: 8px;"></li>
        <li><strong>Tạo thư mục mới:</strong> Nhấp chuột phải vào một khoảng trống -> chọn New -> Folder. Đặt tên thư mục là ThucHanh_TrangGiangLong. Nhấn Enter.<br><img src="assets/Bài 1/1.3.png" style="max-width: 100%; border-radius: 4px; margin-top: 8px;"></li>
        <li><strong>Vào thư mục vừa tạo:</strong> Nhấp đúp vào thư mục ThucHanh_TrangGiangLong.<br><img src="assets/Bài 1/1.4.png" style="max-width: 100%; border-radius: 4px; margin-top: 8px;"></li>
        <li><strong>Tạo tệp tin văn bản:</strong> Nhấp chuột phải vào khoảng trống -> New -> Text Document. Đặt tên là GhiChu.txt. Nhấn Enter.<br><img src="assets/Bài 1/1.5.png" style="max-width: 100%; border-radius: 4px; margin-top: 8px;"></li>
        <li><strong>Đổi tên tệp tin:</strong> Nhấp chuột phải vào tệp GhiChu.txt -> chọn Rename. Đổi tên thành GhiChuQuanTrong.txt. Nhấn Enter.<br><img src="assets/Bài 1/1.6.png" style="max-width: 100%; border-radius: 4px; margin-top: 8px;"></li>
        <li><strong>Tạo thư mục con:</strong> Trong thư mục ThucHanh_TrangGiangLong, nhấp chuột phải -> New -> Folder. Đặt tên là TaiLieu.<br><img src="assets/Bài 1/1.7.png" style="max-width: 100%; border-radius: 4px; margin-top: 8px;"></li>
        <li><strong>Sao chép tệp tin (Copy & Paste):</strong> Nhấp chuột phải vào tệp GhiChuQuanTrong.txt -> chọn Copy. Nhấp đúp vào thư mục TaiLieu, nhấp chuột phải vào khoảng trống bên trong -> chọn Paste.<br><img src="assets/Bài 1/1.8.png" style="max-width: 100%; border-radius: 4px; margin-top: 8px;"></li>
        <li><strong>Di chuyển tệp tin (Cut & Paste):</strong> Quay lại thư mục ThucHanh_TrangGiangLong. Tạo một tệp mới tên là DiChuyen.txt. Nhấp chuột phải vào tệp DiChuyen.txt -> chọn Cut. Nhấp đúp vào thư mục TaiLieu, nhấp chuột phải vào khoảng trống -> chọn Paste. Tệp gốc đã biến mất khỏi vị trí cũ.<br><img src="assets/Bài 1/1.9.png" style="max-width: 100%; border-radius: 4px; margin-top: 8px;"></li>
        <li><strong>Xóa tệp tin:</strong> Trong thư mục TaiLieu, nhấp chuột phải vào tệp GhiChuQuanTrong.txt -> chọn Delete. Tệp sẽ được chuyển vào Thùng rác (Recycle Bin).<br><img src="assets/Bài 1/1.10.png" style="max-width: 100%; border-radius: 4px; margin-top: 8px;"></li>
        <li><strong>Xóa vĩnh viễn:</strong> Chọn tệp DiChuyen.txt, nhấn giữ phím Shift và nhấn phím Delete. Một cảnh báo sẽ hiện ra. Nếu đồng ý, tệp sẽ bị xóa vĩnh viễn mà không qua Thùng rác.<br><img src="assets/Bài 1/1.11.png" style="max-width: 100%; border-radius: 4px; margin-top: 8px;"></li>
        <li><strong>Khôi phục từ Thùng rác (Tùy chọn):</strong> Tìm biểu tượng Recycle Bin trên màn hình nền, nhấp đúp để mở. Tìm tệp GhiChuQuanTrong.txt đã xóa, nhấp chuột phải vào nó và chọn Restore. Tệp sẽ quay trở lại vị trí ban đầu.<br><img src="assets/Bài 1/1.12.png" style="max-width: 100%; border-radius: 4px; margin-top: 8px;"></li>
      </ol>
    `,
    output: `
  ...
  3: {
    ...
    output: `
      <div style="font-size: 13px;">
        ...
        <img src="assets/Bài 3/3.1.png" style="max-width: 100%; border-radius: 6px; margin-bottom: 8px;">
        <img src="assets/Bài 3/3.2.png" style="max-width: 100%; border-radius: 6px; margin-bottom: 8px;">
        <img src="assets/Bài 3/3.3.png" style="max-width: 100%; border-radius: 6px; margin-bottom: 16px;">
    ...
    process: `
      <div style="font-size: 13px; display: flex; flex-direction: column; gap: 16px;">
        ...
        <div>
          ...
          <img src="assets/Bài 4/4.1.png" style="max-width: 100%; border-radius: 6px; margin-top: 8px;">
        </div>
        ...
        <div>
          ...
          <img src="assets/Bài 4/4.2.png" style="max-width: 100%; border-radius: 6px; margin-top: 8px;">
        </div>
        ...
        <div>
          ...
          <img src="assets/Bài 4/4.3.png" style="max-width: 100%; border-radius: 6px; margin-top: 8px;">
        </div>
      </div>
    `,
    output: `
    ...
    process: `
      <div style="font-size: 13px; display: flex; flex-direction: column; gap: 16px;">
        <div>
          ...
          <img src="assets/Bài 5/5.1.png" style="max-width: 100%; border-radius: 6px; margin-top: 8px;">
          <img src="assets/Bài 5/5.2.png" style="max-width: 100%; border-radius: 6px; margin-top: 8px;">
        </div>
        ...
        <div>
          ...
          <img src="assets/Bài 5/5.3.png" style="max-width: 100%; border-radius: 6px; margin-top: 8px;">
        </div>
        ...
        <div>
          ...
          <img src="assets/Bài 5/5.4.png" style="max-width: 100%; border-radius: 6px; margin-top: 8px;">
        </div>
      </div>
    `,
    output: `
...
window.addEventListener("DOMContentLoaded", () => {
  // Hide preloader after a delay to simulate loading
  setTimeout(() => {
    preloader.classList.add("hidden");
  }, 1200);

  // Set initial position for Nav Indicator Pill
  const activeTabBtn = document.querySelector(".nav-toggle.active");
  if (activeTabBtn) {
    updateIndicator(activeTabBtn);
  }

  // Setup interactive glare effect on desktop hero mockup
  if (heroWindow) {
    heroWindow.addEventListener("mousemove", (e) => {
      const rect = heroWindow.getBoundingClientRect();
      const x = e.clientX - rect.left;
      const y = e.clientY - rect.top;
      // Setup relative sweep positioning
      const shineWrapper = heroWindow.querySelector(".shine-wrapper");
      if (shineWrapper) {
        // Stop default looping animation when mouse is hovering and let mouse control it
        shineWrapper.style.animation = "none";
        const percentX = (x / rect.width) * 100;
        shineWrapper.style.transform = `translateX(${percentX - 100}%) skewX(-25deg)`;
      }
    });
    ...
    heroWindow.addEventListener("mouseleave", () => {
      const shineWrapper = heroWindow.querySelector(".shine-wrapper");
      if (shineWrapper) {
        // Re-enable CSS auto sweep animation when mouse leaves
        shineWrapper.style.animation = "shine-sweep 10s infinite ease-in-out";
      }
    });
  }

  // Set up glare coordinate listeners for project cards
...
// Update the position and size of the sliding background nav indicator
...
function switchTab(tabId, element) {
  ...
  const tabButtons = document.querySelectorAll(".nav-toggle");
  ...
  if (element) {
    ...
    // If triggered from footer/links, look up button manually
    const targetBtn = Array.from(tabButtons).find(btn => {
      if (tabId === 'projects') return btn.innerText.includes('Bài tập');
      if (tabId === 'about') return btn.innerText.includes('Giới thiệu');
      if (tabId === 'reflection') return btn.innerText.includes('Tổng kết');
      return false;
    });
    if (targetBtn) {
  ...
  if (targetPane) {
    ...
    // Smooth scroll page back to content start if we are scrolled down
    window.scrollTo({
      top: 350,
      behavior: 'smooth'
    });

    // If switching to About tab, trigger skill bar animation
    if (tabId === 'about') {
      setTimeout(() => {
...
function openModal(id) {
  ...
  if (!data || !projectModal || !modalBodyContent || !modalTitleText) return;

  modalTitleText.innerText = data.badge;

  // Formulate HTML for the modal body content
  modalBodyContent.innerHTML = `
    <!-- Left sidebar containing meta tags -->
    <div class="modal-sidebar">
      <a href="assets/Bài ${id}.pdf" class="btn-modal-action" download style="text-decoration: none;">
        <span>Tải về Báo cáo (PDF)</span>
    ...
    <div class="modal-main-content">
      <div style="margin-bottom: 8px;">
        <h2 style="font-size: 26px; font-weight: 800; font-family: 'Albert Sans', sans-serif; color: #fff; line-height: 1.25;">${data.title}</h2>
      </div>

      <div class="modal-section">
        <h4 class="modal-section-title">Mục tiêu bài tập</h4>
      ...
      <div class="modal-section">
        <h4 class="modal-section-title">Quy trình thực hiện</h4>
        <div class="modal-section-body">
          ${data.process}
        </div>
      </div>
      ...
      <div class="modal-section">
        <h4 class="modal-section-title">Sản phẩm &amp; Chi tiết kết quả</h4>
        <div class="modal-section-body">
          ${data.output}
        </div>
      </div>
...
// Update navbar active state indicator on window resize
